...
from textual.widgets import (
    Header, Footer, Tree, Static, Button, Input, Label,
    Checkbox, TextArea, DirectoryTree
)
...
class MenuconfigApp(App):
    ...
    def on_menuconfig_tree_section_toggled(self, message: MenuconfigTree.SectionToggled) -> None:
...
def main():
    """Main entry point"""
    if len(sys.argv) != 2:
        print("Usage: claude_menuconfig.py <CLAUDE.md_file>")
        sys.exit(1)
