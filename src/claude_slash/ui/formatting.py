...
def create_status_panel(
    title: str, content: str, status: str = "info", expand: bool = True
) -> Panel:
    """
    ...
    return Panel(content, title=panel_title, style=style, expand=expand)


def create_info_table(
    data: List[Tuple[str, str]], title: Optional[str] = None, show_header: bool = False
) -> Table:
    """
...
def format_error_message(
    message: str, details: Optional[str] = None, prefix: str = "Error"
) -> str:
    """
...
def format_success_message(
    message: str, details: Optional[str] = None, prefix: str = "Success"
) -> str:
    """
...
def format_warning_message(
    message: str, details: Optional[str] = None, prefix: str = "Warning"
) -> str:
    """
...
def format_info_message(
    message: str, details: Optional[str] = None, prefix: str = "Info"
) -> str:
    """
...
def create_command_help_panel(
    ...
    return Panel(content, title=f"📖 Help: {command_name}", style="blue", expand=False)
